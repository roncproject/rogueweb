...
How to run on AWS: 
 ...
 - Opening the app on a PC browser looks fine, but on a mobile phone initially only shows a black screen with instructions. Using the move-buttons make the player-figure appear. 
